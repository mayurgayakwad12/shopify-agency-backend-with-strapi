...
export interface ApiBrandsLogoBrandsLogo extends Struct.CollectionTypeSchema {
  collectionName: 'brands_logos';
  info: {
    description: '';
    displayName: 'Brands Logo';
    pluralName: 'brands-logos';
    singularName: 'brands-logo';
  };
  options: {
...
export interface ApiWebDesignWorkWebDesignWork
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::web-design-work.web-design-work'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::brands-logo.brands-logo': ApiBrandsLogoBrandsLogo;
      'api::case-study.case-study': ApiCaseStudyCaseStudy;
      'api::quote.quote': ApiQuoteQuote;
      'api::service-card.service-card': ApiServiceCardServiceCard;
      'api::web-design-work.web-design-work': ApiWebDesignWorkWebDesignWork;
